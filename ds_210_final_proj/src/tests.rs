...
mod tests {
    ...
    #[test]
    fn test_read_csv() {
        // Prepare a CSV string (makes it easier for testing)
    ...
    #[test]
    fn test_load_data() {
        // Prepares data for temporary txt
        ...
        // Loads data into a graph and verifies
    ...
    fn test_six_degrees_to_all() {
        ...
        assert_eq!(result.len(), 2); // Expected: distances for 2 characters
